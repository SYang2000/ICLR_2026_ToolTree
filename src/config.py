...
class LLMConfig:
    ...
    api_key: str = ""
    base_url: str = ""
    # When True (default), every request carries the vLLM/Qwen-specific
    # extra_body {"chat_template_kwargs": {"enable_thinking": false}} that
    # disables Qwen "thinking" blocks. Set False for non-vLLM
    # OpenAI-compatible endpoints, which may reject or misinterpret it.
    enable_thinking_toggle: bool = True
...
class ToolTreeConfig:
    ...
    benchmark: str = "gta"
    tool_execution: str = "mock"  # "mock" (step-by-step) | "real"
